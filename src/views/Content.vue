...
<script setup>
	...
	import { timeSince, urlify, isOnlyWhiteSpace } from '@/utils';
	...
	contentStore.getContentById(contentId.value);

	const { singlePost: post } = storeToRefs(contentStore);
	...
	async function handleLike(post) {
		...
		await contentStore.getContentById(contentId.value);
	}
